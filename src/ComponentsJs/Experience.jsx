...
export function Experience() {
  ...
  <div className="exp-cont" style={{display:'flex', }}>
    <div className="exp" style={{width:'30%', textAlign:'left',}}><h2 style={{marginLeft:'35px'}}>EXPERINCE</h2></div>
    ...
    width:'70%'
      ...
      <div className="exp-header-details" style={{
        ...
        <ul>
          <li className='li'>Worked well in team environment as well as independently</li>
          <li className='li'>Worked with team to support goals and build experience</li>
          <li className='li'>Help staff members to re-stock suppliesan and perform other administrative tasks</li>
          <li className='li'>Attended and Participated in meetings and brainstorming sessions with team members</li>
          <li className='li'>Attended and Participated in meetings and brainstorming sessions with team members</li>
          <li className='li'>PROJECTS: Assisted in a Time To Pay Prjoect</li>
        </ul>
      </div>
    </div>
  </div>
